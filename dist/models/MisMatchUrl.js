...
var MisMatchUrlSchema = new Schema({
  step: {
...
MisMatchUrlSchema.plugin(_mongooseError2.default);
MisMatchUrlSchema.plugin(_mongooseFindorcreate2.default);

exports.default = _mongoose2.default.model('MisMatchUrl', MisMatchUrlSchema);